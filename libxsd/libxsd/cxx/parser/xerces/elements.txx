// file      : libxsd/cxx/parser/xerces/elements.txx
...
#include <libxsd/cxx/xml/sax/bits/error-handler-proxy.hxx>
#include <libxsd/cxx/xml/bits/literals.hxx> // xml::bits::{xml_prefix, etc}
