// file      : libxsd/cxx/tree/type-serializer-map.txx
// license   : GNU GPL v2 + exceptions; see accompanying LICENSE file

#include <xercesc/util/XMLUni.hpp>
#include <xercesc/validators/schema/SchemaSymbols.hpp>

#include <libxsd/cxx/xml/bits/literals.hxx> // xml::bits::{xsi_namespace, type}
#include <libxsd/cxx/xml/dom/serialization-source.hxx> // dom::{create_*, prefix}
