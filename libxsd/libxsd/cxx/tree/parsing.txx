// file      : libxsd/cxx/tree/parsing.txx
// license   : GNU GPL v2 + exceptions; see accompanying LICENSE file

#include <string>

#include <libxsd/cxx/ro-string.hxx>         // trim

#include <libxsd/cxx/xml/string.hxx>        // xml::{string, transcode}
#include <libxsd/cxx/xml/elements.hxx>      // xml::{prefix, uq_name}
#include <libxsd/cxx/xml/bits/literals.hxx> // xml::bits::{xml_prefix,
                                         //             xml_namespace}

#include <libxsd/cxx/tree/exceptions.hxx>   // no_prefix_mapping
#include <libxsd/cxx/tree/elements.hxx>
#include <libxsd/cxx/tree/types.hxx>
#include <libxsd/cxx/tree/list.hxx>
