  ...
  namespace Tree
  {
    ...
    generate_tree_header (Context& ctx)
    {
      if (ctx.generate_xml_schema)
      {
        ...
        {
          ctx.os << "#include <libxsd/cxx/xml/char-" << ctx.char_encoding <<
            ".hxx>" << endl
                 << endl;
        }

        ctx.os << "#include <libxsd/cxx/tree/exceptions.hxx>" << endl
               << "#include <libxsd/cxx/tree/elements.hxx>" << endl
               << "#include <libxsd/cxx/tree/types.hxx>" << endl
               << endl;

        if (!ctx.options.suppress_parsing () ||
            ctx.options.generate_serialization ())
        {
          ctx.os << "#include <libxsd/cxx/xml/error-handler.hxx>" << endl
                 << endl;
        }
        ...
        if (!ctx.options.suppress_parsing () ||
            ctx.options.generate_serialization ())
        {
          ctx.os << "#include <libxsd/cxx/xml/dom/auto-ptr.hxx>" << endl
                 << endl;
        }
        ...
        if (element_map)
          ctx.os << "#include <libxsd/cxx/tree/element-map.hxx>" << endl
                 << endl;
        ...
        if (!ctx.options.suppress_parsing ())
        {
          ctx.os << "#include <libxsd/cxx/tree/parsing.hxx>" << endl;
          ...
          if (element_map)
            ctx.os << "#include <libxsd/cxx/tree/parsing/element-map.txx>" <<
              endl;
        ...
        {
          ctx.os << "#include <libxsd/cxx/xml/dom/serialization-header.hxx>" << endl
                 << "#include <libxsd/cxx/tree/serialization.hxx>" << endl;
          ...
          if (element_map)
            ctx.os << "#include <libxsd/cxx/tree/serialization/element-map.txx>" <<
              endl;
        ...
        {
          ctx.os << "#include <libxsd/cxx/tree/std-ostream-operators.hxx>" << endl
                 << endl;
        }
        ...
        if (!ist.empty ())
        {
          ...
          {
            if (*i == "ACE_OutputCDR")
              ctx.os << "#include <libxsd/cxx/tree/ace-cdr-stream-insertion.hxx>"
                     << endl;
            else if (*i == "XDR")
              ctx.os << "#include <libxsd/cxx/tree/xdr-stream-insertion.hxx>"
                     << endl;
          }

          ctx.os << "#include <libxsd/cxx/tree/stream-insertion.hxx>" << endl
                 << endl;
        }
        ...
        if (!est.empty ())
        {
          ...
          {
            if (*i == "ACE_InputCDR")
              ctx.os << "#include <libxsd/cxx/tree/ace-cdr-stream-extraction.hxx>"
                     << endl;
            else if (*i == "XDR")
              ctx.os << "#include <libxsd/cxx/tree/xdr-stream-extraction.hxx>"
                     << endl;
          }

          ctx.os << "#include <libxsd/cxx/tree/stream-extraction.hxx>" << endl
                 << endl;
        }
      ...
      else
      {
        ...
        ctx.os << "#include <libxsd/cxx/tree/exceptions.hxx>" << endl
               << "#include <libxsd/cxx/tree/elements.hxx>" << endl
               << "#include <libxsd/cxx/tree/containers.hxx>" << endl
               << "#include <libxsd/cxx/tree/list.hxx>" << endl
               << endl;

        if (!ctx.options.suppress_parsing ())
        {
          ctx.os << "#include <libxsd/cxx/xml/dom/parsing-header.hxx>" << endl
                 << endl;
        }
        ...
        if (ctx.options.generate_wildcard ())
        {
          ...
          ctx.os << "#include <libxsd/cxx/tree/containers-wildcard.hxx>" << endl
                 << endl;
        }

        if (!ctx.options.generate_extraction ().empty ())
          ctx.os << "#include <libxsd/cxx/tree/istream-fwd.hxx>" << endl
                 << endl;
