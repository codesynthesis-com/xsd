            ...
            AutoUnlinks& unlinks)
  {
    ...
    try
    {
      ...
      if (gen_cxx && forward)
      {
        ...
        // Version check.
        //
        fwd << "#include <libxsd/cxx/version.hxx>" << endl
            << endl
        ...
        fwd << "#include <libxsd/cxx/pre.hxx>" << endl
              << endl;
        ...
        fwd << "#include <libxsd/cxx/post.hxx>" << endl
            << endl;
      ...
      if (gen_cxx && header)
      {
        ...
        // Version check.
        //
        hxx << "#include <libxsd/cxx/config.hxx>" << endl
            << endl
            << "#if (LIBXSD_VERSION != " << XSD_VERSION << "L)" << endl
            << "#error XSD runtime version mismatch" << endl
            << "#endif" << endl
        ...
        hxx << "#include <libxsd/cxx/pre.hxx>" << endl
            << endl;
        ...
        hxx << "#include <libxsd/cxx/post.hxx>" << endl
              << endl;
      ...
      if (gen_cxx && source)
      {
        ...
        for (size_t part (0); part < parts; ++part)
        {
          ...
          os << "#include <libxsd/cxx/pre.hxx>" << endl
             << endl;
          ...
          os << "#include <libxsd/cxx/post.hxx>" << endl
             << endl;
